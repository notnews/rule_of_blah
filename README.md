...
Equal treatment is the rule of law's central promise: two citizens with identical cases face identical consequences regardless of who judges them. The promise depends on judges applying rules rather than preferences, and on the public believing they do. When the appointing president reliably predicts how a judge votes, neither condition holds.
